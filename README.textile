...
This is the profile that I'm now using across a number of machines that I do web development on.  Most of the tricks I use/found are fairly general and could be reused by anyone.
